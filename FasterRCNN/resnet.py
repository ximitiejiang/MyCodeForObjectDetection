...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 12 17:09:11 2018
...
# ------------------------------------------------------------------------ #
# 之前的程序为pytorch自带实现的resnet源码
# 以下是原作者嵌入的新类
# 注意区别，pytorch自带的resnet类是： class ResNet(nn.Module):
#                     新增加的类是：class resnet(_fasterRCNN):
#------------------------------------------------------------------------- #


'''
创建resnet类：从_fasterRCNN继承而来
通过该新的resnet类，可以直接创建一个基于resnet的fastRCNN网络模型
